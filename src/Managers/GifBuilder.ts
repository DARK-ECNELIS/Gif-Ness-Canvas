...
// import { CanvasImage, CustomColor, Shape, ImagelocationOption, DrawlocationOption, FrameOption, ExpOption, FrameContent, TextOption, NessBuilder, FrameType } from "ness-canvas";
...
export default class GifBuilder {
   ...
   */
  public setExp(option: ExpOption, progress: number, color?: CustomColor): this {
